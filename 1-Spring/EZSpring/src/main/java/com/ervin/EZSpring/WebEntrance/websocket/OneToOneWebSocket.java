package com.ervin.EZSpring.WebEntrance.websocket;
...
public class OneToOneWebSocket {
    ...
    private final Logger log = LoggerFactory.getLogger(OneWebSocket.class);
...
class MyMessage{
    public MyMessage(String message,String userId){
